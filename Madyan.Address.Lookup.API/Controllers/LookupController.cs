...
namespace Madyan.Address.Lookup.API.Controllers
{
    ...
    public class LookupController : ControllerBase
    {
         ...
         * IAddressLookup service = System.Reflection.Assembly.GetExecutingAssembly().CreateInstance("Madyan.Address.Lookup.LoqateAddressLookupService");
         * 
         * service.Find(..);.
         */
        /// </summary>
        ...
        {            
            try
            {
                ...
                if (!_cache.TryGetValue(cacheKey, out result))
                {
                    ...
                    String serviceFullName = "Madyan.Address.Lookup.Services.LookupServices." + lookupService;
